...
public class Version {
    ...
    public static void printVersion() {
        if(logger.isInfoEnabled()) {
            ...
            try {
                InputStream in = SipResourceAdaptor.class.getResourceAsStream("sipra.properties");
                if(in != null) {
                    ...
                    if(releaseVersion != null) {
                        ...
                        logger.info("Release ID: (" + releaseName + ") SIP RA " + releaseVersion + " (build: Git Hash=" + releaseRevision + " date=" + releaseDate + ")");
                        logger.info(releaseName + " SIP RA " + releaseVersion + " (build: Git Hash=" + releaseRevision + " date=" + releaseDate + ") Started.");
                    } else {
                        logger.warn("Unable to extract the version of Restcomm SIP RA currently running");
                    }
                ...
                logger.warn("Unable to extract the version of Restcomm SIP RA currently running", e);
            }
        }
    }
    ...
    public static String getVersion() {
        ...
        try {
            ...
            if(in != null) {
                ...
                return "Release ID: (" + releaseName + ") SIP RA " + releaseVersion + " (build: Git Hash=" + releaseRevision + " date=" + releaseDate + ")";
            }
        } catch (Exception e) {
            logger.warn("Unable to extract the version of Restcomm SIP RA currently running", e);
        }
