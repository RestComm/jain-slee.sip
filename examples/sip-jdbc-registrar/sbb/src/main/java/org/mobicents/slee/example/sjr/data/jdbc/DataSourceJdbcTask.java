...
public abstract class DataSourceJdbcTask extends SimpleJdbcTask {
	...
	static final List<RegistrationBinding> EMPTY_BINDINGS_LIST = Collections
			.emptyList();
	
	public abstract void callBackParentOnException(
			DataSourceParentSbbLocalInterface parent);

	public abstract void callBackParentOnResult(
			DataSourceParentSbbLocalInterface parent);
